...
import DjPersonaRow from "./dj_persona_table";
import DjSetRow from "./dj_set_table";
import MusicRequestRow from "./music_request_table";
...
const reducersSchema = __reducers(
  __reducerSchema("init_set", InitSetReducer),
  __reducerSchema("set_persona", SetPersonaReducer),
  __reducerSchema("set_playback", SetPlaybackReducer),
  __reducerSchema("submit_request", SubmitRequestReducer),
  __reducerSchema("update_pattern", UpdatePatternReducer),
);
